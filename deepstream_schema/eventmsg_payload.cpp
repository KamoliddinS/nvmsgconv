...
generate_sensor_object (void *privData, NvDsEventMsgMeta *meta)
{
  ...
  json_object_set_int_member (sensorObj, "lccum_cnt_entry", dsSensorObj->lccum_cnt_entry);
  json_object_set_int_member (sensorObj, "lccum_cnt_exit", dsSensorObj->lccum_cnt_exit); 
